...
public unsafe delegate void ArcheCallbackRangeAccess(object obj, nint offset, int start, uint length, Delegate access);
...
public static class ArcheAccesses
{
    ...
    private static readonly ConditionalWeakTable<MethodInfo, ConditionalWeakTable<Type, CallbackRangeContainer>>
        callback_range_cache = new();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MethodInfo EmitCallbackRangeAccess(ArcheTypeMeta meta, Type delegateType)
    {
        var target = delegateType.GetMethod("Invoke");
        if (target == null) throw new ArgumentException("The target type does not contain an Invoke method");
        return callback_range_cache.GetOrCreateValue(target).GetOrCreateValue(meta.Type)
            .Get(meta, target, delegateType);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static MethodInfo EmitCallbackRangeAccess(Type unit_type, Type delegateType)
    {
        var target = delegateType.GetMethod("Invoke");
        if (target == null) throw new ArgumentException("The target type does not contain an Invoke method");
        return callback_range_cache.GetOrCreateValue(target).GetOrCreateValue(unit_type)
            .Get(unit_type, target, delegateType);
    }
    ...
    {
        public static readonly MethodInfo Method =
            EmitCallbackRangeAccess(typeof(C), typeof(D));
        // ReSharper disable once StaticMemberInGenericType
        public static readonly ArcheCallbackRangeAccess Func = Method.CreateDelegate<ArcheCallbackRangeAccess>();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Access(object obj, nint offset, int start, uint length, D acc) =>
